...
class RunTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.user = {"name": "test", "password": "test", "email": "test@gmail.com"}
        self.shopping_list = {"name": "bakery", "user_id": 1}
        self.item = {"name": "sweetpotatoes"}
    ...
    def test_user_login_with_correct_password(self):
        ...
        res = self.app.post('/auth/register', data=json.dumps(self.user))
    ...
    def test_reset_password_with_non_existent_user(self):
        """Test user reset password"""
        self.app.post('/auth/register', data=json.dumps(self.user),
                      headers={'Content-Type': 'application/json','access-token':'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEsImlhdCI6MTUwNjAxMzYzMCwiZXhwIjoxNTA2MDE0ODMwfQ.2NFkud0nKlSAcX_9ePH7K_aPmF6vWZ5t54qS_jdms-A'})
        reset = self.app.post('/auth/reset-password',
    ...
    def test_view_all_shopping_lists(self):
        ...
        result = self.app.get('/shoppinglists/', headers={'Content-Type': 'application/json','access-token':'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEsImlhdCI6MTUwNjAxMzYzMCwiZXhwIjoxNTA2MDE0ODMwfQ.2NFkud0nKlSAcX_9ePH7K_aPmF6vWZ5t54qS_jdms-A'})
        self.assertEqual(result.status_code, 200)
    ...
    def test_view_on_shopping_list(self):
        ...
        result = self.app.get('/shoppinglists/1', headers={'Content-Type': 'application/json','access-token':'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEsImlhdCI6MTUwNjAxMzYzMCwiZXhwIjoxNTA2MDE0ODMwfQ.2NFkud0nKlSAcX_9ePH7K_aPmF6vWZ5t54qS_jdms-A'})
        self.assertEqual(result.status_code, 404)
    ...
    def test_delete_shopping_list(self):
        ...
        result = self.app.delete('/shoppinglists/1',headers={'Content-Type': 'application/json','access-token':'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEsImlhdCI6MTUwNjAxMzYzMCwiZXhwIjoxNTA2MDE0ODMwfQ.2NFkud0nKlSAcX_9ePH7K_aPmF6vWZ5t54qS_jdms-A'})
        self.assertEqual(result.status_code, 404)
        self.assertIn('Shopping list can not be found', str(result.data))
        self.app.post('/auth/register', data=json.dumps(self.user),
                      headers={'Content-Type': 'application/json','access-token':'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEsImlhdCI6MTUwNjAxMzYzMCwiZXhwIjoxNTA2MDE0ODMwfQ.2NFkud0nKlSAcX_9ePH7K_aPmF6vWZ5t54qS_jdms-A'})
    ...
    def test_delete_item_from_shopping_list(self):
        self.app.post('/auth/register', data=json.dumps(self.user),
                      headers={'Content-Type': 'application/json','access-token':'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEsImlhdCI6MTUwNjAxMzYzMCwiZXhwIjoxNTA2MDE0ODMwfQ.2NFkud0nKlSAcX_9ePH7K_aPmF6vWZ5t54qS_jdms-A'})
        deleted = self.app.delete('/shoppinglists/1/items/1',headers={'Content-Type': 'application/json','access-token':'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEsImlhdCI6MTUwNjAxMzYzMCwiZXhwIjoxNTA2MDE0ODMwfQ.2NFkud0nKlSAcX_9ePH7K_aPmF6vWZ5t54qS_jdms-A'})
