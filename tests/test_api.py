...
class AuthTestCase(unittest.TestCase):
    ...
    def register_user(self, name='test', email="test@gmail.com", password="test1234"):
        ...
        return self.app.post('/v1/auth/register', data=json.dumps(user_data), content_type='application/json')
    ...
    def login_user(self, email="test@gmail.com", password="test1234"):
        ...
        return self.app.post('/v1/auth/login', data=json.dumps(user_data), content_type='application/json')
    ...
    def test_create_shopping_list_for_registered_user(self):
        ...
        with self.app:
            ...
            result = self.app.post('/v1/shoppinglists/', data=json.dumps(self.shopping_list),
    ...
    def test_view_all_shopping_lists(self):
        ...
        res = self.app.post('/v1/shoppinglists/', data=json.dumps(self.shopping_list),
                            headers={'Content-Type': 'application/json', 'access-token': access_token})
        self.assertEqual(res.status_code, 201)

        get_result = self.app.get('/v1/shoppinglists', headers={'Content-Type': 'application/json',
    ...
    def test_search_shopping_lists(self):
        ...
        get_result = self.app.get('/v1/shoppinglists?q=test_list', headers={'Content-Type': 'application/json',
                                                                            'access-token': access_token})
        self.assertEqual(get_result.status_code, 200)
    ...
    def test_view_one_shopping_list(self):
        ...
        get_result = self.app.get('/v1/shoppinglists/1', headers={'Content-Type': 'application/json',
                                                                  'access-token': access_token})
        self.assertEqual(get_result.status_code, 200)
    ...
    def test_update_shopping_list(self):
        ...
        update_res = self.app.put('/v1/shoppinglists/1', data=json.dumps({"name": "new_name"}),
                                  headers={'Content-Type': 'application/json', 'access-token': access_token})
    ...
    def test_delete_shopping_list(self):
        ...
        get_result = self.app.get('/v1/shoppinglists/1', headers={'Content-Type': 'application/json',
                                                                  'access-token': access_token})
        self.assertEqual(get_result.status_code, 200)
        del_result = self.app.delete('/v1/shoppinglists/1', headers={'Content-Type': 'application/json',
                                                                     'access-token': access_token})
    ...
    def test_add_item_to_shopping_list(self):
        ...
        get_result = self.app.get('/v1/shoppinglists/1', headers={'Content-Type': 'application/json',
                                                                  'access-token': access_token})
        self.assertEqual(get_result.status_code, 200)
        item = self.app.post('/v1/shoppinglists/1/items', data=json.dumps(self.item),
                             headers={'Content-Type': 'application/json', 'access-token': access_token})
    ...
    def test_update_item_in_shopping_list(self):
        ...
        item = self.app.post('/v1/shoppinglists/1/items', data=json.dumps(self.item),
                             headers={'Content-Type': 'application/json', 'access-token': access_token})
        self.assertEqual(item.status_code, 201)
        update_item = self.app.put('/v1/shoppinglists/1/items/1', data=json.dumps({"name": "new_name"}),
                                   headers={'Content-Type': 'application/json', 'access-token': access_token})
    ...
    def test_view_items_in_shopping_list(self):
        ...
        item = self.app.post('/v1/shoppinglists/1/items', data=json.dumps(self.item),
                             headers={'Content-Type': 'application/json', 'access-token': access_token})
        self.assertEqual(item.status_code, 201)
        view_item = self.app.get('/v1/shoppinglists/1/items',
                                 headers={'Content-Type': 'application/json', 'access-token': access_token})
    ...
    def test_delete_item_from_shopping_list(self):
        ...
        delete_item = self.app.delete(
            '/v1/shoppinglists/1/items/1', headers={'Content-Type': 'application/json', 'access-token': access_token})
